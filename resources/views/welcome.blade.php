...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        <div class="m-0 p-0">
            @if (Route::has('login'))
                <div class="d-flex justify-content-between p-2 my-1 ">
            ...
            <div class="container-fluid">
                ...
                <ul class="d-flex justify-content-center p-2 list-inline ">
                  <li class=" ">
                    <a class="nav-link px-3  mx-3 btn btn btn-outline-info " href="#">Accueil</a>
                  </li>
                  <li class="">
                    <a class="nav-link px-3  mx-3 btn btn-outline-info" href="{{route('articles.index')}}">Blog</a>
                  </li>
                  <li class="">
                    <a class="nav-link px-3  mx-3 btn btn-outline-info" href="#">Hotel</a>
                  </li>
                  <li class="">
                    <a class="nav-link px-3  mx-3 btn btn-outline-info" href="#">Tronsport</a>
                  </li>
                  <li class="">
                    <a class="nav-link px-3  mx-3 btn btn-outline-info" href="#">Voyage Organisé</a>
                  </li>
                </ul>
              </div>
          <hr class="mx-5">
